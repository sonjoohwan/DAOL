 ...
 */
@WebServlet("/mailSendMulti")
public class MailSendServletMulti extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MailSendServletMulti() {
        super();
	...
	*/		
	...
	//5) 
			 ...
			 * 
			 * if(receiver.contains(";")) {//true : "이메일1;" 한 명, "이메일1;이메일2"여러 명 receivers =
			 * receiver.split(";"); Address[] receiver_addAddresses = new
			 * Address[receivers.length]; for(int i = 0 ; i < receivers.length ; i++) {
			 * receiver_addAddresses[i] = new
			 * InternetAddress(receivers[i].trim());//javax.mail } //★★ 주의 : add~s로 끄탐
			 * message.addRecipients(Message.RecipientType.TO, receiver_addAddresses); }else
			 * { //false : "이메일1" 한명 Address receiver_address = new
			 * InternetAddress(receiver); message.addRecipient(Message.RecipientType.TO,
			 * receiver_address);//수신자 메일주소 셋팅 }
			 */
			/*---------------------------------------------------------------------------------------*/
		    ...
		    Hashtable<Object, Object> mailData = null;
			Part msg = null;
