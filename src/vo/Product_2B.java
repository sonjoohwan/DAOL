...
public class Product_2B {
	...
	public Product_2B(int product_no, String product_name, String product_cap, String product_char, String product_desc,
	...
	public String toString() {
		return "Product_2B [product_no=" + product_no + ", product_name=" + product_name + ", product_cap="
