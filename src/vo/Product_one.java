...
public class Product_one {
	...
	public Product_one(int product_no, String product_name, String product_cap, String product_char, String product_desc,
	...
	public String toString() {
		return "Product_one [product_no=" + product_no + ", product_name=" + product_name + ", product_cap="
