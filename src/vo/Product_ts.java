...
public class Product_ts {
	...
	public Product_ts(int product_no, String product_name, String product_cap, String product_char, String product_desc,
	...
	public String toString() {
		return "Product_ts [product_no=" + product_no + ", product_name=" + product_name + ", product_cap="
