...
public class Product_et {
	...
	public Product_et(int product_no, String product_name, String product_cap, String product_char, String product_desc,
	...
	public String toString() {
		return "Product_et [product_no=" + product_no + ", product_name=" + product_name + ", product_cap="
