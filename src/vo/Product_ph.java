...
public class Product_ph {
	...
	public Product_ph(int product_no, String product_name, String product_cap, String product_char, String product_desc,
	...
	public String toString() {
		return "Product_ph [product_no=" + product_no + ", product_name=" + product_name + ", product_cap="
