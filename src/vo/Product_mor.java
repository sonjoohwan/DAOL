...
public class Product_mor {
	...
	public Product_mor(int product_no, String product_name, String product_cap, String product_char, String product_desc,
	...
	public String toString() {
		return "Product_mor [product_no=" + product_no + ", product_name=" + product_name + ", product_cap="
