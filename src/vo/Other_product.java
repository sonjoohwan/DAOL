...
public class Other_product {
	...
	public Other_product() {
		super();
	}


	public Other_product(int product_no, String product_name, String product_cap, String product_char,
			String product_desc, String product_use, String product_image) {
		super();
	...
	public String toString() {
		return "Other_product [product_no=" + product_no + ", product_name=" + product_name + ", product_cap="
