    ...
    <div class="row">
        <div class="col-md-3 col-sm-4">
            <div class="product-grid8">
                <div class="product-image8">
                    <a href="https://www.facebook.com/profile.php?id=100064090957235">
                        <img class="pic-1" src="images/다올 페이스북 이미지.jpg">
                        <img class="pic-2" src="images/다올 페이스북.jpg">
                    </a>
                    <ul class="social">
                        <li><a href="" class="fa fa-search"></a></li>
                    </ul>
                    <span class="product-discount-label">facebook</span>
                </div>
                <div class="product-content">
                    <div class="price">다올 코스메틱 공식 페이스북
                    </div>
                    <HR>
                    <h3 class="title">다올 제품과 소식을 빠르게 접할수 있는 곳! <br>다올코스메틱 공식 페이스북</h3>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid8">
                <div class="product-image8">
                    ...
                    <span class="product-discount-label" style="background-color: rgba(225,48,108)">instagram</span>
                </div>
                <div class="product-content">
                    <div class="price">다올 코스메틱 공식 인스타그램
                    </div>
                    <HR>
                    <h3 class="title">다올코스메틱 에스테틱오픈 및 컨설팅&교육  <br>다올코스메틱 공식 인스타그램</h3>
                    <a class="all-deals" href="https://www.facebook.com/profile.php?id=100064090957235">바로 가기<i class="fa fa-angle-right icon"></i></a>
                </div>
            </div>
        </div>
           <div class="col-md-3 col-sm-6">
            <div class="product-grid8">
                ...
                <div class="product-content">
                    <div class="price">유경아카데미 공식 인스타그램
                    </div>
                    <HR>
                    <h3 class="title">에스테틱 문화를 선도하는 글로벌 NO.1브랜드  <br>유경아카데미 공식 인스타그램</h3>
        ...
        <div class="row" style="margin-top: 40px;">
         <div class="col-md-3 col-sm-6">
            <div class="product-grid8">
                ...
                <div class="product-content">
                    <div class="price">Phfomula 공식 인스타그램
                    </div>
                    <HR>
                    <h3 class="title">업계 최초 파마 코스메슈디컬 에스테틱 브랜드  <br>Phfomula 공식 인스타그램</h3>
            ...
            <div class="product-grid8">
                ...
                <div class="product-content">
                    <div class="price">Etelanc 공식 인스타그램
                    </div>
                    <HR>
                    <h3 class="title">에스테틱 화장품 전문 브랜드 에텔랑  <br>Etelanc 공식 인스타그램</h3>
       ...
       <div class="col-md-3 col-sm-6">
            <div class="product-grid8">
                ...
                <div class="product-content">
                    <div class="price">D.L the aroma 공식 인스타그램
                    </div>
                    <HR>
                    <h3 class="title">하이퀄리티 아로마 전문 브랜드 디엘더아로마 <br>D.L the aroma 공식 인스타그램</h3>
         ...
         <div class="col-md-3 col-sm-6">
            <div class="product-grid8">
                ...
                <div class="product-content">
                    <div class="price">2B Bio Beauty 공식 인스타그램
                    </div>
                    <HR>
                    <h3 class="title">30년전통의 고품격 오리지날 알라딘 필링  <br>2B Bio Beauty 공식 인스타그램</h3>
            ...
            <div class="product-grid8">
                <div class="product-image8">
                    ...
                    <span class="product-discount-label" style="background-color: rgba(250,9,16)">youtube</span>
                </div>
                <div class="product-content">
                    <div class="price">유경아카데미 공식 유투브
                    </div>
                    <HR>
                    <h3 class="title">에스테틱 지식과 기술 교육을 한눈에   <br>유경아카데미 공식 유투브</h3>
       ...
       <div class="col-md-3 col-sm-6">
            <div class="product-grid8">
                ...
                <div class="product-content">
                    <div class="price">픽부샵 공식 유투브
                    </div>
                    <HR>
                    <h3 class="title">우리가 픽한 에스테틱 피부샵   <br>픽부샵 공식 유투브</h3>
         ...
         <div class="col-md-3 col-sm-6">
            <div class="product-grid8">
                ...
                <div class="product-content">
                    <div class="price">에부심 공식 유투브
                    </div>
                    <HR>
                    <h3 class="title">에스테틱 마케팅 이건 알고 하세요!  <br> 에부심 공식 유투브</h3>
