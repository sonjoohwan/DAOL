...
<div class="s-div">
		<dl class="ss-dl">  
		<dt class="fo_noto" style="color:rgb(72, 70, 70); ">브랜드 소개3</dt>
...
<br>
<div class="container">
		<a href="news_detail_1_2.jsp"><button type="button" class="btn btn-outline-success" style="float: left;">이전 글</button></a> &nbsp;
		<a href="news_detail_1_4.jsp"><button type="button" class="btn btn-outline-success" style="float: left; margin-left: 10px;">다음 글</button></a>
