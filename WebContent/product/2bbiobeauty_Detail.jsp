...
<meta name="viewport" content="width=device-width", initial-scale="1" >  <!-- 반응형 웹에 사용하는 메타태그 -->
 <link rel="stylesheet" href="css/productDetailPage_2B.css">
...
<div class="container-fluid">
    <div class="content-wrapper">	
     <div class="heading-section">
	            <h2 style="color: rgba(2,111,52);"><b>${product_2BView.product_name}</b></h2>
	        </div>
	        <hr>
    <section id = "listForm">
				<div class="product">
						<img id="item-display"  src="images/${product_2BView.product_image}"/></img>
				</div>	
				<div class="product-detail" >
					<div class="product-desc">상품명 :  <b>${product_2BView.product_name}</b></div>
					<div class="product-desc">용량 :  <b>${product_2BView.product_cap}</b>    </div>
					<hr>
					<div class="product-desc">특징 :  <b>${product_2BView.product_char}</b></div>
					<div class="product-stock">사용법 : <b>${product_2BView.product_use}</b></div>
					<div class="product-desc">제품 설명 : <b>${product_2BView.product_desc}</b></div>
					<hr>
					<br>
						<nav id = "commandList" style="float: right;">
							<a class="round-black-btn" href="product_2B.daol"><strong>제품 다시 보기</strong></a>
